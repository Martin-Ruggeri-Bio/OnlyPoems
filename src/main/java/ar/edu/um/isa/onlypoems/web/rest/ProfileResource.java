...
/**
 * REST controller for managing {@link ar.edu.um.isa.onlypoems.domain.Profile}.
 */
@RestController
@RequestMapping("/api")
public class ProfileResource {
     ...
     */
    @GetMapping("/profiles")
    public List<Profile> getAllProfiles(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
