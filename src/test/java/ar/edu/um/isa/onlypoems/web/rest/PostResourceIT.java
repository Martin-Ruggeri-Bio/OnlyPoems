...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().title(DEFAULT_TITLE).content(DEFAULT_CONTENT).genre(DEFAULT_GENRE).date(DEFAULT_DATE);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().title(UPDATED_TITLE).content(UPDATED_CONTENT).genre(UPDATED_GENRE).date(UPDATED_DATE);
        return post;
    }
    ...
    void createPost() throws Exception {
        ...
        assertThat(testPost.getGenre()).isEqualTo(DEFAULT_GENRE);
    ...
    void putNewPost() throws Exception {
        ...
        updatedPost.title(UPDATED_TITLE).content(UPDATED_CONTENT).genre(UPDATED_GENRE).date(UPDATED_DATE);
        ...
        assertThat(testPost.getGenre()).isEqualTo(UPDATED_GENRE);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.title(UPDATED_TITLE).content(UPDATED_CONTENT).genre(UPDATED_GENRE).date(UPDATED_DATE);
