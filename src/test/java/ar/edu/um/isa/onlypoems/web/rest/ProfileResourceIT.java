...
class ProfileResourceIT {
    ...
    public static Profile createEntity(EntityManager em) {
        Profile profile = new Profile().name(DEFAULT_NAME).email(DEFAULT_EMAIL).handle(DEFAULT_HANDLE);
        return profile;
    }
    ...
    public static Profile createUpdatedEntity(EntityManager em) {
        Profile profile = new Profile().name(UPDATED_NAME).email(UPDATED_EMAIL).handle(UPDATED_HANDLE);
        return profile;
    }
    ...
    void createProfile() throws Exception {
        ...
        assertThat(testProfile.getHandle()).isEqualTo(DEFAULT_HANDLE);
    }
    ...
    void putNewProfile() throws Exception {
        ...
        updatedProfile.name(UPDATED_NAME).email(UPDATED_EMAIL).handle(UPDATED_HANDLE);
        ...
        assertThat(testProfile.getHandle()).isEqualTo(UPDATED_HANDLE);
    }
    ...
    void partialUpdateProfileWithPatch() throws Exception {
        ...
        partialUpdatedProfile.name(UPDATED_NAME).email(UPDATED_EMAIL).handle(UPDATED_HANDLE);
