...
describe('Post e2e test', () => {
  ...
  const postSample = {
    title: 'visualize Montenegro HDD',
    content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=',
    genre: 'Rojo',
    date: '2023-01-23T20:18:44.187Z',
  };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      ...
      cy.get(`[data-cy="genre"]`).type('Métricas Pollo').should('have.value', 'Métricas Pollo');

      cy.get(`[data-cy="date"]`).type('2023-01-23T18:26').blur().should('have.value', '2023-01-23T18:26');
